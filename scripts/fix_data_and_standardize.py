...
print('변경 사항:')
print('  1. sugar_free 컬럼 추가 (일반당=0, 무설탕=1)')
print('  2. price, sugar_free, health_label Z-score 표준화')
print('  3. 원본 값은 *_original 컬럼에 보존')
print()

print('=' * 100)
print('✅ 데이터 수정 및 표준화 완료!')
print('=' * 100)
print()

print('🔧 다음 단계:')
print('  1. 순차추정 재실행: python test_sequential_estimation.py')
print('  2. 부트스트랩 재실행: python test_sequential_bootstrap.py --n_bootstrap 1000')
print('  3. 결과 비교')
print()

print('📊 기대 효과:')
print('  - sugar_free 변수 정상 작동')
print('  - 완벽한 스케일 균형 (모든 변수 std=1)')
print('  - 잠재변수 유의성 개선 예상')
print()
